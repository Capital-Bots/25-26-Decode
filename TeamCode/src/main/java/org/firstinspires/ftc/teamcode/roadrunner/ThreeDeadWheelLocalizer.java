...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1712.8310015078987; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1*1850.2672310160117; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1*1295.084263929089; // x position of the perpendicular encoder (in tick units)
    }
